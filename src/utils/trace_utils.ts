...
import {CompletionResponse, TraceLog} from "../types.js";
...
const traceInsert = (traceId: string, data: { [key: string]: any }) => {
...
const trace = (funcName: string, func: (...args: any[]) => any, name?: string, tags?: string[], metadata?: any, target?: string, endUserIdentifier?: string) => {
